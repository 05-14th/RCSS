...
Public Class rptARMonitoring
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RCSS.rptARMonitoring.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptARMonitoring
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptARMonitoring = New rptARMonitoring()
        rpt.Site = Me.Site
        Return rpt
    End Function
