...
Public Class rptPrintCollection
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RCSS.rptPrintCollection.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Name_of_Collection_Officer() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Position_of_Collection_Encoder() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPrintCollection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintCollection = New rptPrintCollection()
        rpt.Site = Me.Site
        Return rpt
    End Function
